<template>
    <div class="searchBar"> 
        ...
        <template v-for="item in searchElems">
            ...
            <!-- time -->
            <span v-if="item.type==='time'" class="searchBar-item">
                <span v-if="item.title" class="searchBar-title">{{item.title}}:</span>
                <DatePicker v-model="cSerachValue[item.key]" :type="item.timeType||'date'" :placeholder="item.placeholder" :style="item.style"></DatePicker>
            </span>
