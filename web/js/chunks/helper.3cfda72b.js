        ...
        render: function render(h, params) {
          return h('div', [h(
            'a',
            {
              ...
              on: {
                'click': _this.run.bind(null, params.row.name)
              }
            },
            ['\u542F\u52A8']
          ), '\xA0\xA0', h(
            'a',
            {
              attrs: { href: 'javascript:;' },
              on: {
                'click': _this.editPage.bind(null, params)
              }
            },
            ['\u6253\u5305']
          )]);
...
var render = function() {
  ...
  return _c(
    ...
    [
          ...
          _c(
            ...
            [
              ...
              _c("Input", {
                ...
                attrs: { placeholder: "要插入的页面地址", clearable: "" },
                model: {
                  value: _vm.fileName,
                  callback: function($$v) {
                    _vm.fileName = $$v
      ...
      _vm._v(" "),
      _c("Modal", {
        attrs: { title: "title", width: "1400px", "footer-hide": "" },
        model: {
          value: _vm.showModal,
          callback: function($$v) {
            _vm.showModal = $$v
    ...
    [
      ...
      _vm.tableData.edit
        ? _c(
            ...
            [
              _vm._v("\n    编辑内容设置：\n    "),
              _c("dyForm", { ref: "editForm", attrs: { type: "edit" } })
            ],
            1
          )
        : _vm._e(),
          ...
          [
            ...
            _c(
              ...
              _vm._l(_vm.tableTypes, function(type) {
                return _c("Option", { key: type, attrs: { value: type } }, [
                  _vm._v(_vm._s(type))
                ])
              }),
              1
            ...
            _c(
              ...
              [
                _c("Option", { key: "left", attrs: { value: "left" } }, [
                  _vm._v("left")
                ]),
                _vm._v(" "),
                _c("Option", { key: "right", attrs: { value: "right" } }, [
                  _vm._v("right")
                ])
              ],
              1
            ...
            _c(
              ...
              [
                ...
                _vm._v(" "),
                _c("Option", { key: "center", attrs: { value: "center" } }, [
                  _vm._v("center")
                ])
              ],
              1
                  ...
                  _c(
                    ...
                    [
                      _vm.hasParm(item.type, "clearable")
                        ? _c(
                            "Checkbox",
                            { key: "clearable", attrs: { label: "clearable" } },
                            [_vm._v("可清空")]
                          )
                        : _vm._e(),
                      _vm._v(" "),
                      _c(
                        "Checkbox",
                        { key: "labelGroup", attrs: { label: "labelGroup" } },
                        [_vm._v("label组")]
                      ),
                      _vm._v(" "),
                      _vm.hasParm(item.type, "multiple")
                        ? _c(
                            "Checkbox",
                            { key: "multiple", attrs: { label: "multiple" } },
                            [_vm._v("多选")]
                          )
                        : _vm._e(),
                      _vm._v(" "),
                      ...
                      _vm.hasParm(item.type, "compass")
                        ? _c(
                            "Checkbox",
                            { key: "compass", attrs: { label: "compass" } },
                            [_vm._v("组合")]
                          )
                        : _vm._e()
                    ],
...
/* harmony default export */ var formvue_type_script_lang_js_ = ({
  ...
  data: function data() {
    return {
      ...
      formTypes: ["input", "select", "radio", "checkbox", "textarea", "switch", "date", "daterange", "year", "month", "time", "timerange", "inputNumber", "password"],
...
/* harmony default export */ var dynamicvue_type_script_lang_js_ = ({
  ...
  mounted: function mounted() {
    ...
    this.clipboard.on('success', function (e) {
      _this2.$Message.success('源码已copy到剪贴板，请直接粘贴使用');
      e.clearSelection();
    });
    this.clipboard.on('error', function (e) {
      _this2.$Message.error('copy失败');
    });
  },
                  ...
                  return _c(
                    ...
                    [
                      _c("img", {
                        ...
                        attrs: { src: "/storeImg/" + item2.name + ".png" }
                      }),
                      _vm._v(" "),
                      ...
                      _c(
                        ...
                        [
                          ...
                          _c(
                            "Tooltip",
                            {
                              attrs: { content: "查看文档", placement: "top" }
                            },
                            [
                              _c("Icon", {
                          ...
                          _c(
                            "Tooltip",
                            {
                              attrs: { content: "查看源码", placement: "top" }
                            },
                            [
                              _c("Icon", {
                          ...
                          _c(
                            "Tooltip",
                            {
                              attrs: { content: "组件预览", placement: "top" }
                            },
                            [
                              _c("Icon", {
                                attrs: { type: "md-eye" },
        ...
        [
          ...
          _vm.cComponents.name
            ? _c("div", [
                _c("img", {
                  staticClass: "docImg",
                  attrs: { src: "/storeImg/" + _vm.cComponents.name + ".png" }
                })
              ])
            : _vm._e(),
          _vm._v(" "),
...
// EXTERNAL MODULE: ./src/views/dynamic/index.vue + 14 modules
  ...
  methods: {
    ...
    getModules: function getModules() {
      ...
      request["a" /* default */].get('api/vue/getComponets').then(function (data) {
        ...
        types.forEach(function (item) {
          ...
          obj.components = _this.getComponetsByType(item, data.infos);
          arr.push(obj);
        });
        _this.components = arr;
    ...
    checkCode: function checkCode(item) {
      ...
      request["a" /* default */].post('api/vue/checkCode', { components: components }).then(function (data) {
        _this3.key++;
        _this3.codeTitle = item.cName + ' \u6E90\u7801';
        _this3.$store.dispatch('index/setCode', data);
        _this3.codeModal = true;
      });
    },
