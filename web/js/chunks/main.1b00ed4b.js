...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_ref_2_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_13877386_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("NFqt");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_ref_2_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_13877386_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_ref_2_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_13877386_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_ref_2_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_13877386_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0___default.a); 
        ...
        [
          _c("Header", [
            _c("div", { staticClass: "layout-logo" }, [
              _vm._v("FEhelper\n        "),
              _c("div", { staticClass: "layout-menu" }, [
                _c("a", { attrs: { href: "#/manage/manage" } }, [
                  _vm._v("项目管理")
                ]),
                _vm._v(" "),
                _c("a", { attrs: { href: "#/" } }, [_vm._v("组件开发")]),
                _vm._v(" "),
                _c("a", { attrs: { href: "#/dynamic/dynamic" } }, [
                  _vm._v("动态组件")
                ])
              ])
            ])
...
// EXTERNAL MODULE: ./src/layout/index.vue?vue&type=style&index=0&id=13877386&lang=less&scoped=true&
var layoutvue_type_style_index_0_id_13877386_lang_less_scoped_true_ = __webpack_require__("NLN4");
...
var baseRoutes = [{
  ...
  children: [{
    ...
    name: "index",
    component: function component() {
      return Promise.all(/* import() | helper */[__webpack_require__.e(4), __webpack_require__.e(1)]).then(__webpack_require__.bind(null, "N/kD"));
    },
    meta: {
      title: "组件布局"
    },
  ...
  children: [{
    ...
    name: "manage",
    component: function component() {
      return Promise.all(/* import() | helper */[__webpack_require__.e(4), __webpack_require__.e(1)]).then(__webpack_require__.bind(null, "+owy"));
    },
    meta: {
      title: "组件管理"
    },
  ...
  children: [{
    ...
    name: "dynamic",
    component: function component() {
      return Promise.all(/* import() | helper */[__webpack_require__.e(4), __webpack_require__.e(1)]).then(__webpack_require__.bind(null, "BbHQ"));
    },
    meta: {
      title: "动态组件"
    },
...
// CONCATENATED MODULE: ./src/store/modules/components.js
function components_toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }
...
var actions = {
  ...
  //设置组件列表
  setComponent: function setComponent(_ref2, componentList) {
  ...
  //变更文件地址
  editAddress: function editAddress(_ref3, value) {
  ...
  //设置源码
  setCode: function setCode(_ref4, value) {
...
var mutations = {
  //uuid递增
  uuidAdd: function uuidAdd(state) {
    state.uuid += 1;
  },

  //设置组件列表
  setComponent: function setComponent(state, componentList) {
    state.componentList = [].concat(components_toConsumableArray(componentList));
  },

  //变更文件地址
  editAddress: function editAddress(state, value) {
    state.address = value;
  },
...
var modules_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

function modules_toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }
...
var modules_actions = {
  ...
  //添加组件
  addComponent: function addComponent(_ref3, value) {
    var commit = _ref3.commit;
  ...
  //当前操作的项目及文件
  setProject: function setProject(_ref5, value) {
...
var modules_mutations = {
  ...
  //设置组件列表
  setComponent: function setComponent(state, componentList) {
    state.componentList = [].concat(modules_toConsumableArray(componentList));
  },

  //添加组件
  addComponent: function addComponent(state, value) {
  ...
  setProject: function setProject(state, value) {
    state.project = modules_extends({}, value);
  }
};
...
/* harmony default export */ var modules = ({
  ...
  actions: modules_actions,
  mutations: modules_mutations
});
...
// EXTERNAL MODULE: ./node_modules/highlight.js/styles/googlecode.css
var googlecode = __webpack_require__("66Jr");

// EXTERNAL MODULE: ./node_modules/view-design/dist/iview.js
var iview = __webpack_require__("+CXx");
var iview_default = /*#__PURE__*/__webpack_require__.n(iview);

// EXTERNAL MODULE: ./node_modules/view-design/dist/styles/iview.css
var styles_iview = __webpack_require__("+M7m");
